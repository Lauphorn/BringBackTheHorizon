...
public class IkHand : MonoBehaviour
{
    ...
    public float WeightTimerLeft, WeightTimerRight;
    public bool ChangeWeightLeft, ChangeWeightRight;
    ...
    void Update()
    {
        ...
        RightHandWeight = WeightCurve.Evaluate(WeightTimerRight);
        LeftHandWeight = WeightCurve.Evaluate(WeightTimerLeft);

        if (ChangeWeightLeft && WeightTimerLeft < 1)
        {
            WeightTimerLeft += Time.deltaTime;
        }
        if (!ChangeWeightLeft && WeightTimerLeft > 0)
        {
            WeightTimerLeft -= Time.deltaTime;
        }

        if (ChangeWeightRight && WeightTimerRight < 1)
        {
            WeightTimerRight += Time.deltaTime;
        }
        if (!ChangeWeightRight && WeightTimerRight > 0)
        {
            WeightTimerRight -= Time.deltaTime;
        }
    }
    ...
    {
        ChangeWeightLeft = !ChangeWeightLeft;
    }

    public void WeightRight()
    {
        ChangeWeightRight = !ChangeWeightRight;
    }
