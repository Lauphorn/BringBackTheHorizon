...
public class CameraController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            characterRotation.rotation = Quaternion.Slerp(characterRotation.rotation, m_CharacterTargetRot, 5 * Time.deltaTime);
            ...
            cam.localRotation = Quaternion.Slerp(cam.localRotation, m_CameraTargetRot, 5 * Time.deltaTime);
